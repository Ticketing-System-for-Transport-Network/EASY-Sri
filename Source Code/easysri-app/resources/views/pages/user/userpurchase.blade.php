...
@section('content')
    ...
    <div class="container">
        ...
        <div class="userinfo">
            ...
            <h5 class="card-title mt-1"><strong>User Name : </strong><small>{{ $udata->Fname }} {{ $udata->Lname }}</small>
            </h5>
            ...
            <h5 class="card-title mt-1"><strong>Account Created Date : </strong><small>
                    {{ date('Y-m-d', strtotime($udata->created_at)) }}</small></h5>
                        ...
                        <div class="payment">
                            <form action="{{ route('storeusertopup') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-4 ">
                                    <div class="alert-danger text-danger" style="font-size: 15px">
                                        <small>{{ $errors->first('amount') }}</small></div>
